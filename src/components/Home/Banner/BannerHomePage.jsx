export default function BannerHomePage() {
  return (
    <div className=" flex h-[900px] w-auto items-center justify-center ">
      {/* Background */}
      <div className="relative flex h-full items-center justify-center">
        ...
        <div className="absolute lg:left-20">
          <div className="relative flex flex-col text-center text-shuttlegray lg:text-left">
          ...
          {/* Icon */}
          <div className="absolute -left-6 -top-6 mobile:hidden sm:hidden lg:block">
            <img
